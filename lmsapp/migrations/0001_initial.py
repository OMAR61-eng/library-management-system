# Generated by Django 5.0.14 on 2025-07-29 03:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('available', 'Available'), ('sold', 'sold'), ('rentaled', 'rentaled')], max_length=50, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='lmsapp.category')),
            ],
        ),
    ]
